...
import 'bottom_navigation_bar_org_model.dart';
export 'bottom_navigation_bar_org_model.dart';

class BottomNavigationBarOrgWidget extends StatefulWidget {
  const BottomNavigationBarOrgWidget({
    super.key,
  ...
  @override
  State<BottomNavigationBarOrgWidget> createState() =>
      _BottomNavigationBarOrgWidgetState();
}

class _BottomNavigationBarOrgWidgetState
    extends State<BottomNavigationBarOrgWidget> with TickerProviderStateMixin {
  late BottomNavigationBarOrgModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BottomNavigationBarOrgModel());
