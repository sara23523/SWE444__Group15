...
import 'bottom_navigation_bar_sol_model.dart';
export 'bottom_navigation_bar_sol_model.dart';

class BottomNavigationBarSolWidget extends StatefulWidget {
  const BottomNavigationBarSolWidget({
    super.key,
  ...
  @override
  State<BottomNavigationBarSolWidget> createState() =>
      _BottomNavigationBarSolWidgetState();
}

class _BottomNavigationBarSolWidgetState
    extends State<BottomNavigationBarSolWidget> with TickerProviderStateMixin {
  late BottomNavigationBarSolModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BottomNavigationBarSolModel());
