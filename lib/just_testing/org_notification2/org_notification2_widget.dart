...
import 'org_notification2_model.dart';
export 'org_notification2_model.dart';

class OrgNotification2Widget extends StatefulWidget {
  const OrgNotification2Widget({super.key});

  @override
  State<OrgNotification2Widget> createState() => _OrgNotification2WidgetState();
}

class _OrgNotification2WidgetState extends State<OrgNotification2Widget> {
  late OrgNotification2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgNotification2Model());
  }
