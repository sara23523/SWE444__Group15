...
class OrgHomepageWidget extends StatefulWidget {
  const OrgHomepageWidget({super.key});

  @override
  State<OrgHomepageWidget> createState() => _OrgHomepageWidgetState();
}

class _OrgHomepageWidgetState extends State<OrgHomepageWidget>
    with TickerProviderStateMixin {
  late OrgHomepageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgHomepageModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ChallengesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ChallengesRecord> orgHomepageChallengesRecordList = snapshot.data!;
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                        FutureBuilder<
                                                                            int>(
                                                                      future:
                                                                          queryRepliesRecordCount(
                                                                        queryBuilder:
                                                                            (repliesRecord) =>
                                                                                repliesRecord.where(
                                                                          'challengeRef',
                                                                          isEqualTo:
                                                                              listViewChallengesRecord.reference,
                                                                        ),
                                                                      ),
                                                                      builder:
                                                                          (context,
