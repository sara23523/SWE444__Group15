...
import 'org_homepage_copy_model.dart';
export 'org_homepage_copy_model.dart';

class OrgHomepageCopyWidget extends StatefulWidget {
  const OrgHomepageCopyWidget({super.key});

  @override
  State<OrgHomepageCopyWidget> createState() => _OrgHomepageCopyWidgetState();
}

class _OrgHomepageCopyWidgetState extends State<OrgHomepageCopyWidget> {
  late OrgHomepageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgHomepageCopyModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ChallengesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ChallengesRecord> orgHomepageCopyChallengesRecordList =
            snapshot.data!;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FutureBuilder<int>(
                                future: querySolutionsRecordCount(),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                                            ...
                                            Padding(
                                              padding: const EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      10.0, 0.0, 10.0, 0.0),
                                              child: Text(
                                                'View challenges posted by your organization and track progress.\n',
                                    ...
                                    child:
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<ChallengesRecord>
                                            ...
                                            snapshot.data!;
                                        if (listViewChallengesRecordList
                                            .isEmpty) {
                                          return Center(
                                            child: SvgPicture.asset(
                                              'assets/images/emptyState.svg',
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            valueOrDefault<String>(
                                                                              listViewChallengesRecord.title,
                                                                              'challenge title',
                                                                            ),
                                                                            ...
                                                                            children: [
                                                                              Flexible(
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Text(
                                                                                    listViewChallengesRecord.description.maybeHandleOverflow(
                                                                                      maxChars: 60,
                                                                                      replacement: '…',
                                                                                    ),
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return GestureDetector(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              padding: MediaQuery.viewInsetsOf(context),
                                                                              child: MoreWidget(
                                                                                challengeRef: listViewChallengesRecord.reference,
                                                                              ),
                                                                            ),
                                                                          );
                                                                        },
