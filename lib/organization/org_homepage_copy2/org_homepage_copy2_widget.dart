...
import 'org_homepage_copy2_model.dart';
export 'org_homepage_copy2_model.dart';

class OrgHomepageCopy2Widget extends StatefulWidget {
  const OrgHomepageCopy2Widget({super.key});

  @override
  State<OrgHomepageCopy2Widget> createState() => _OrgHomepageCopy2WidgetState();
}

class _OrgHomepageCopy2WidgetState extends State<OrgHomepageCopy2Widget> {
  late OrgHomepageCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgHomepageCopy2Model());
