...
class OrgViewSolutionsWidget extends StatefulWidget {
  const OrgViewSolutionsWidget({
    super.key,
    this.challengeID,
  });
  ...
  @override
  State<OrgViewSolutionsWidget> createState() => _OrgViewSolutionsWidgetState();
}

class _OrgViewSolutionsWidgetState extends State<OrgViewSolutionsWidget> {
  late OrgViewSolutionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgViewSolutionsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ChallengesRecord>(
      stream: ChallengesRecord.getDocument(widget.challengeID!),
      builder: (context, snapshot) {
        ...
        final orgViewSolutionsChallengesRecord = snapshot.data!;
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FutureBuilder<int>(
                          future: FFAppState().challengeDetails(
                            requestFn: () => queryRepliesRecordCount(),
                          ),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
                            ...
                            int userList5Count = snapshot.data!;
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    orgViewSolutionsChallengesRecord
                                                        .title,
                                    ...
                                    if (orgViewSolutionsChallengesRecord
                                                .descriptionFile !=
                                            '')
                                      Align(
                                        alignment:
