...
import 'solver_profile_page_model.dart';
export 'solver_profile_page_model.dart';

class SolverProfilePageWidget extends StatefulWidget {
  const SolverProfilePageWidget({
    super.key,
  ...
  @override
  State<SolverProfilePageWidget> createState() =>
      _SolverProfilePageWidgetState();
}

class _SolverProfilePageWidgetState extends State<SolverProfilePageWidget> {
  late SolverProfilePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SolverProfilePageModel());
  }
                                ...
                                return StreamBuilder<List<ChallengesRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    final containerChallengesRecord =
                                        containerChallengesRecordList.isNotEmpty
                                            ? containerChallengesRecordList
                                                .first
                                            : null;
