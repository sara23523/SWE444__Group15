...
import 'view_challenges_copy_model.dart';
export 'view_challenges_copy_model.dart';

class ViewChallengesCopyWidget extends StatefulWidget {
  const ViewChallengesCopyWidget({super.key});

  @override
  State<ViewChallengesCopyWidget> createState() =>
      _ViewChallengesCopyWidgetState();
}

class _ViewChallengesCopyWidgetState extends State<ViewChallengesCopyWidget> {
  late ViewChallengesCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewChallengesCopyModel());
  }
