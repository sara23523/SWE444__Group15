...
import 'view_solvers1_model.dart';
export 'view_solvers1_model.dart';

class ViewSolvers1Widget extends StatefulWidget {
  const ViewSolvers1Widget({super.key});

  @override
  State<ViewSolvers1Widget> createState() => _ViewSolvers1WidgetState();
}

class _ViewSolvers1WidgetState extends State<ViewSolvers1Widget> {
  late ViewSolvers1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewSolvers1Model());
  }
                                          ...
                                          return GestureDetector(
                                            ...
                                            child: Padding(
                                              ...
                                              child: SolverProfileWidget(
                                                solver: listViewUsersRecord,
                                                ref: listViewUsersRecord
                                                    .reference,
                                              ),
                                            ),
                                          );
