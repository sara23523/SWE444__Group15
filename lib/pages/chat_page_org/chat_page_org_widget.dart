...
import 'chat_page_org_model.dart';
export 'chat_page_org_model.dart';

class ChatPageOrgWidget extends StatefulWidget {
...
class _ChatPageOrgWidgetState extends State<ChatPageOrgWidget> {
  late ChatPageOrgModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatPageOrgModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ChatsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final chatPageOrgChatsRecord = snapshot.data!;
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: (_model.textController.text == '')
                                ...
                                : () async {
                                    ...
                                    if (chatPageOrgChatsRecord.lastMessageSeenBy
                                            .contains(
                                      ...
                                      triggerPushNotification(
                                        ...
                                        notificationText:
                                            chatPageOrgChatsRecord.lastMessage,
                                        userRefs: [widget.user!.reference],
                                        initialPageName: 'Chats',
                                        parameterData: {},
                                      );
                                    } else {
                                      return;
