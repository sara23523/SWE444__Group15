                          ...
                          child: StreamBuilder<List<OrganizationRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<OrganizationRecord>
                                  userAvatarOrganizationRecordList =
                                  snapshot.data!;
                              // Return an empty Container when the item does not exist.
                              if (snapshot.data!.isEmpty) {
                                return Container();
                              }
                              final userAvatarOrganizationRecord =
                                  userAvatarOrganizationRecordList.isNotEmpty
                                      ? userAvatarOrganizationRecordList.first
                                      : null;
                              ...
                              return InkWell(
                                ...
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(60.0),
                                  child: Image.network(
                                    userAvatarOrganizationRecord!.photoUrl,
                                    width: 80.0,
                                    height: 80.0,
                                    fit: BoxFit.cover,
                                  ),
                            ...
                            children: [
                              StreamBuilder<List<OrganizationRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<OrganizationRecord>
                                      textUserNameOrganizationRecordList =
                                      snapshot.data!;
                                  // Return an empty Container when the item does not exist.
                                  if (snapshot.data!.isEmpty) {
                                    return Container();
                                  }
                                  final textUserNameOrganizationRecord =
                                      textUserNameOrganizationRecordList
                                              .isNotEmpty
                                          ? textUserNameOrganizationRecordList
                                              .first
                                  ...
                                  return Text(
                                    valueOrDefault<String>(
                                      textUserNameOrganizationRecord
                                          ?.displayName,
                                      'sarah',
                                    ),
                              ...
                              Padding(
                                ...
                                child: StreamBuilder<List<OrganizationRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<OrganizationRecord>
                                        textEmailAddressOrganizationRecordList =
                                        snapshot.data!;
                                    // Return an empty Container when the item does not exist.
                                    if (snapshot.data!.isEmpty) {
                                      return Container();
                                    }
                                    final textEmailAddressOrganizationRecord =
                                        textEmailAddressOrganizationRecordList
                                                .isNotEmpty
                                            ? textEmailAddressOrganizationRecordList
                                                .first
                                    ...
                                    return Text(
                                      valueOrDefault<String>(
                                        textEmailAddressOrganizationRecord
                                            ?.email,
                                        'sarah@gmail.com',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                              ...
                              Padding(
                                ...
                                child: StreamBuilder<List<OrganizationRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return Text(
                                      valueOrDefault<String>(
                                        textEmailAddressOrganizationRecord?.bio,
                                        '....',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
