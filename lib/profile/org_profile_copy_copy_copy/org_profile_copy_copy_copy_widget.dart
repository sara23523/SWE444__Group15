...
import 'org_profile_copy_copy_copy_model.dart';
export 'org_profile_copy_copy_copy_model.dart';

class OrgProfileCopyCopyCopyWidget extends StatefulWidget {
  const OrgProfileCopyCopyCopyWidget({super.key});

  @override
  State<OrgProfileCopyCopyCopyWidget> createState() =>
      _OrgProfileCopyCopyCopyWidgetState();
}

class _OrgProfileCopyCopyCopyWidgetState
    extends State<OrgProfileCopyCopyCopyWidget> {
  late OrgProfileCopyCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgProfileCopyCopyCopyModel());
  }
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  ...
                  options: FFButtonOptions(
                    ...
                    height: 38.0,
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 16.0, 0.0),
                    iconAlignment: IconAlignment.start,
                    iconPadding:
                        const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 0.0),
                    color: const Color(0x21FF5963),
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Padding(
                        ...
                        child: StreamBuilder<List<UsersRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<UsersRecord> textUserNameUsersRecordList =
                                snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            ...
                            final textUserNameUsersRecord =
                                textUserNameUsersRecordList.isNotEmpty
                                    ? textUserNameUsersRecordList.first
                                    : null;
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0.0, 4.0, 0.0, 30.0),
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(90.0, 0.0, 90.0, 20.0),
                      child: Material(
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('OrgTransactionsSummary');
                        },
                        child: Material(
                          color: Colors.transparent,
                          elevation: 0.0,
