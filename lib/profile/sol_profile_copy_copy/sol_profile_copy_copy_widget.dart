...
import '/solver/upload_confirmation_dialog/upload_confirmation_dialog_widget.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:provider/provider.dart';
import 'sol_profile_copy_copy_model.dart';
export 'sol_profile_copy_copy_model.dart';

class SolProfileCopyCopyWidget extends StatefulWidget {
  const SolProfileCopyCopyWidget({super.key});

  @override
  State<SolProfileCopyCopyWidget> createState() =>
      _SolProfileCopyCopyWidgetState();
}

class _SolProfileCopyCopyWidgetState extends State<SolProfileCopyCopyWidget> {
  late SolProfileCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SolProfileCopyCopyModel());
  }
                  ...
                  children: [
                                  ...
                                  builder: (context) {
                                    return GestureDetector(
                                      ...
                                      child: Padding(
                                        ...
                                        child: UploadConfirmationDialogWidget(
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('solverTransactionsSummary');
                        },
                        child: Material(
                          color: Colors.transparent,
                          elevation: 0.0,
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed('solverTransactionsSummary');
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.start,
