                                ...
                                child: StreamBuilder<List<ChallengesRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<ChallengesRecord>
                                        textChallengesRecordList =
                                        snapshot.data!;
                                    // Return an empty Container when the item does not exist.
                                    if (snapshot.data!.isEmpty) {
                                      return Container();
                                    }
                                    final textChallengesRecord =
                                        textChallengesRecordList.isNotEmpty
                                            ? textChallengesRecordList.first
                                            : null;
                                    ...
                                    return InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        _model.text = await ChallengesRecord
                                            .getDocumentOnce(
                                                textChallengesRecord!
                                                    .reference);
