...
class SolDetailsWidget extends StatefulWidget {
  const SolDetailsWidget({
    ...
    required this.desc,
    required this.solTitle,
  });

  final DocumentReference? chalRef;
  final String? desc;
  final String? solTitle;
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            20.0, 12.0, 20.0, 4.0),
                        child: Text(
                          columnChallengesRecord.description,
                          style:
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        valueOrDefault<String>(
                                          widget.desc,
                                          'NOT WORKING,check details desc',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
