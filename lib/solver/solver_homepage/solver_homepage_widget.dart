              ...
              SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      flex: 5,
                                      child: Text(
                                        'Upload Your Resume and Boost Your Chances of Getting Hired!',
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(30.0, 0.0, 0.0, 15.0),
                      child: Text(
                        'Overview',
                    ...
                    Padding(
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) =>
                            FutureBuilder<List<ChallengesRecord>>(
                          future: FFAppState().recommendedChallenge(
                            requestFn: () => queryChallengesRecordOnce(
                              queryBuilder: (challengesRecord) =>
                                  challengesRecord
                                      .whereArrayContainsAny(
                                          'selectedCategories',
                                          (currentUserDocument?.category2
                                                  .toList() ??
                                              []))
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        ...
                                        extra: <String, dynamic>{
                                          'challenge': listViewChallengesRecord,
                                        },
                                      );
                                    },
                                    child: Container(
