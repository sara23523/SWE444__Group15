...
import 'solver_homepage_copyy_model.dart';
export 'solver_homepage_copyy_model.dart';

class SolverHomepageCopyyWidget extends StatefulWidget {
  const SolverHomepageCopyyWidget({super.key});

  @override
  State<SolverHomepageCopyyWidget> createState() =>
      _SolverHomepageCopyyWidgetState();
}

class _SolverHomepageCopyyWidgetState extends State<SolverHomepageCopyyWidget> {
  late SolverHomepageCopyyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SolverHomepageCopyyModel());
