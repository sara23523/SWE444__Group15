...
import '/solver/delete_file_confirmation_dialog_s_o_l/delete_file_confirmation_dialog_s_o_l_widget.dart';
...
class SubmitsolWidget extends StatefulWidget {
  const SubmitsolWidget({
    ...
    required this.challengWholeDoc,
  });

  final DocumentReference? challenge;
  final ChallengesRecord? challengWholeDoc;
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            'Enter your Solution title here...',
                                                      ...
                                                      child: Padding(
                                                        padding: MediaQuery
                                                            .viewInsetsOf(
                                                                context),
                                                        child:
                                                            const DeleteFileConfirmationDialogSOLWidget(),
                                                      ),
                                                    );
                                                  },
                                                ).then((value) =>
                                        ...
                                        child: Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 10.0),
                                          child: Text(
                                            'Set visibility for your Solution',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Inter',
